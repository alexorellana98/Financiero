...
<script language="javascript">
  ...
  var cond= $("#condi").val();
  if (cond==1) {
     window.location="http://localhost/fina/siccif/vistas/ActivoFijo/Movimiento.blade.php";
  }else{window.location="http://localhost/fina/siccif/vistas/ActivoFijo/MovimientoInactivo.blade.php";}
