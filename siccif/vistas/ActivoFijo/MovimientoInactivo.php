        ...
        <!-- Title -->
          <div class="row heading-bg">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
              <h5 align="center" class="txt-dark">Movimientos Inactivos</h5>
            </div>
          </div>
          <!-- /Title -->
                            ...
                            $cont=$cont+1;
                              ...
                              <tr>
                                ...
                                <td>
                                 ...
                                 <form  style="margin-left: 100px; margin-top:-43px;" action="Movimiento.php" method="get" class="form-register" > 
