...
<script language="javascript">
 ...
 function sele(){
  var cond= $("#condi").val();
  if (cond==1) {
     window.location="http://localhost/fina/siccif/vistas/ActivoFijo/Ubicacion.blade.php";
  }else{window.location="http://localhost/fina/siccif/vistas/ActivoFijo/UbicacionInactivo.blade.php";}
